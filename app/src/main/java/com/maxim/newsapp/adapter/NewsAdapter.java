package com.maxim.newsapp.adapter;
...
import com.maxim.newsapp.databinding.NewsItemBinding;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.NewsViewHolder> {
    ...
    public void setArticles(List<Article> articles, boolean isAdd) {
        if (articles != null) {

            if(!isAdd) this.articles = articles;
            else addAll(articles);
